<template>
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
        ...
        <!-- This section is for the Dashboard Header -->
        <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
            ...
            <div class="flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
                ...
                <div class="bg-white rounded flex items-center w-full max-w-xl mr-4 p-2 shadow-sm border border-gray-200">
                    ...
                    <!-- Navbar Right {Log Out section} -->
                <ul class="flex items-center">
                  <li>
                      <button @click="Show_loan_form = !Show_loan_form" class="rounded bg-blue-500 hover:bg-blue-700 py-2 px-4 text-white">Loan</button>
                      <span class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-red-500 animate-ping"></span>
                      <span class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-red-500"></span>
                  </li>
                    <li>
    ...
    <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          ...
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li @click="Show_loan_form = !Show_loan_form">
              <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
                </span>
                <span class="ml-2 text-sm tracking-wide truncate">Apply for loan</span>
                <span class="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-blue-500 bg-indigo-50 rounded-full">New Loan</span>
              </a>
            </li>
          ...
          <p class="mb-14 px-5 py-3 hidden md:block text-center text-xs">Copyright @2022 S-techmax</p>

        </div>
    </div>

    <!-- More features, for Now the side bar ends here! -->
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        <!-- Loan Application Form -->
        <div class="mt-8 mx-4" v-if="Show_loan_form">
          <h1 style="color: red; background: pink">Loan Application Form</h1>
        ...
        <!-- Main Dashboard {Statistics Card} -->
                ...
                <div class="block w-full">
                    ...
                    <div class="flex-grow flex items-center border-b border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                      <div class="flex-grow flex justify-between items-center">
                        <div class="self-center">
                          <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">David Maxwell</a> Maide a payment 
                        </div>
                  ...
                  <li class="flex px-4">
                    ...
                    <div class="flex-grow flex items-center border-gray-100 text-sm text-gray-600 dark:text-gray-50 py-2">
                      <div class="flex-grow flex justify-between items-center">
                        <div class="self-center">
                         <a class="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Success David</a> Applied for new loan. 
                        </div>
                        <div class="flex-shrink-0 ml-2">
                          <a class="flex items-center font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500" href="#0" style="outline: none;">
                            View<span><svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" class="transform transition-transform duration-500 ease-in-out"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg></span>
